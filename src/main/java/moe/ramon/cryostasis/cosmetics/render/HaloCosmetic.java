 ...
 * transcribed from the original 1.8 model. The original bobbed the ring up and down over
 * time; that animation is a follow-up, the static ring is the first pass.
 */
